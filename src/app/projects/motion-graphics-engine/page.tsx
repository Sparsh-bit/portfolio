...
import { ChevronLeft, ArrowUpRight, Play, Layers } from "lucide-react";
import Link from "next/link";
import { useEffect } from "react";
import Navbar from "@/components/ui/Navbar";

const CaseStudy = ({ title, subtitle, description, imageSrc, tech, demo }: any) => (
    <section className="py-32 px-6 md:px-16 max-w-7xl mx-auto border-b border-white/5">
        <div className="grid lg:grid-cols-[0.8fr_1.2fr] gap-20 items-center">
            ...
            >
                ...
                {demo && (
                    <button className="inline-flex items-center gap-4 text-[10px] font-bold tracking-[0.4em] uppercase text-gold hover:text-white transition-all duration-500 group">
                        <Play size={16} />
                        Interactive Demo
            ...
            <motion.div
                ...
                className="relative aspect-video bg-zinc-950 rounded-sm overflow-hidden border border-white/10 shadow-2xl group cursor-pointer"
            >
                <img
                    src={imageSrc}
                    alt={title}
                ...
                <div className="absolute top-8 left-8 flex items-center gap-4">
                    ...
                    <span className="text-[9px] font-bold tracking-[0.4em] uppercase text-white/40">Motion Engine</span>
                </div>
...
const InteractiveMotionScene = () => {
    ...
    return (
        ...
        >
            {/* Figma-inspired Motion Graphics Glows */}
            <div className="absolute inset-0 bg-gradient-radial from-purple-500/15 via-transparent to-transparent blur-[120px] rounded-full scale-110 animate-pulse" />
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-gradient-to-tr from-pink-500/8 via-transparent to-cyan-500/8 opacity-70 blur-[80px] rounded-full" />
            ...
            <div className="relative w-full h-full max-w-[750px] flex items-center justify-center">
                ...
                >
                    {/* Advanced Motion Graphics Composition */}
                    <div className="relative w-full h-full">
                        ...
                        >
                            <div className="w-full h-full bg-gradient-to-br from-purple-500/25 to-pink-500/15 rounded-full border-2 border-purple-400/40 backdrop-blur-sm shadow-2xl" />
                            {/* Animated Rings */}
                            <motion.div
                                animate={{ rotate: 360 }}
                            ...
                            <motion.div
                                ...
                                className="absolute inset-6 border border-pink-400/40 rounded-full"
                            />
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="absolute top-1/4 left-1/4 w-24 h-24 border-3 border-cyan-400/50 transform-gpu"
                            style={{ transformStyle: 'preserve-3d' }}
                        >
                            <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/15 to-transparent rotate-45" />
                            <div className="absolute inset-2 border-2 border-cyan-400/25 rotate-12" />
                            <div className="absolute inset-4 bg-gradient-to-tl from-cyan-500/10 to-transparent rotate-90" />
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="absolute bottom-1/4 right-1/4 w-18 h-18 bg-gradient-to-br from-pink-500/25 to-purple-500/15 border-2 border-pink-400/40 shadow-xl"
                        >
                            <div className="absolute inset-1 bg-gradient-to-tl from-purple-500/15 to-transparent rounded-sm" />
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="absolute top-1/3 right-1/3 w-28 h-28 border-2 border-purple-400/35 transform-gpu"
                            style={{ transformStyle: 'preserve-3d' }}
                        >
                            <div className="absolute inset-2 border border-purple-400/25 rotate-x-45 rotate-y-45" />
                            <div className="absolute inset-4 border border-pink-400/25 rotate-x-90" />
                            <div className="absolute inset-6 border border-cyan-400/25 rotate-y-90" />
                        </motion.div>
                        ...
                        {Array.from({ length: 16 }).map((_, i) => (
                            <motion.div
                                ...
                                className="absolute w-2 h-2 bg-gradient-to-r from-cyan-400/50 to-pink-400/50 rounded-full blur-sm"
                                style={{
                        ...
                        <motion.div
                            ...
                            className="absolute top-1/6 left-1/6 w-12 h-12 bg-gradient-to-br from-purple-500/20 to-cyan-500/20 border border-purple-400/30"
                        />
                    </div>
                ...
                <div className="absolute -inset-22 border border-purple-400/[0.03] rounded-xl pointer-events-none hidden xl:block" />
            </div>
        </motion.div>
    );
};
        ...
        <main className="min-h-screen bg-[#020202] text-white selection:bg-gold selection:text-black font-montserrat overflow-x-hidden">
            ...
            <div className="pb-40">
                <CaseStudy
                    ...
                    description="High-performance particle system with GPU acceleration, supporting complex motion graphics, fluid simulations, and interactive storytelling elements."
                    imageSrc="https://images.unsplash.com/photo-1635070041078-e363dbe005cb?auto=format&fit=crop&q=80&w=2000"
                    tech={["WebGL", "Canvas API", "GPU Computing", "TypeScript"]}
                    demo={true}
                />

                <CaseStudy
                    title="Narrative Animation Library"
                    subtitle="Storytelling Through Motion"
                    description="Comprehensive animation library designed for cinematic storytelling, featuring advanced easing functions, timeline controls, and narrative sequencing."
                    imageSrc="https://images.unsplash.com/photo-1558655146-d09347e92766?auto=format&fit=crop&q=80&w=2000"
                    tech={["JavaScript", "SVG", "CSS Animations", "React"]}
                    demo={true}
                />
            </div>
            ...
            <section className="py-48 text-center bg-[#050505] relative overflow-hidden">
                <div className="max-w-4xl mx-auto px-6 relative z-10">
                    <span className="text-gold text-[9px] font-bold tracking-[0.8em] uppercase block mb-12 opacity-60">Cultural Innovation</span>
                    <h2 className="text-[clamp(2.5rem,6vw,4.5rem)] font-cinzel font-bold text-white mb-16 leading-[1.1] uppercase">Explore Cultural <br /><span className="text-white/20">Heritage Platform.</span></h2>
                    <Link
                    ...
                    >
                        ...
                        <span className="relative text-[10px] font-bold tracking-[0.4em] uppercase text-white group-hover:text-black transition-colors duration-700">View Platform</span>
                ...
                <div className="absolute inset-0 opacity-[0.1] grayscale pointer-events-none select-none">
                    <Layers className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 text-gold/5" />
                </div>
            </section>
